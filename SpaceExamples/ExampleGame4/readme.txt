...
It was tested using the RGBDS assembler and linker and the NO$GMB emulator.

The "setpath.bat" batch file sets my compile paths my RGBDS directory (where
I have the assembler and linker, as well as rgbfix.exe).

The "mk.bat" batch file runs my compile.
