;****************************************************************************************************************************************************
;*	HelloWorld.asm - Hello world source code
;*
;****************************************************************************************************************************************************
;*
;*
...
;****************************************************************************************************************************************************
	; system includes
	INCLUDE	"DevrsIncludeFiles/HARDWARE.INC"
...
Start::
	...
	call WAIT_VBLANK 	;wait for the v-blank
	...
	ld a, %11100100		;load a normal pallete
	ldh [rBGP], a		;load the pallette
